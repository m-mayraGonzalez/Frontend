...
export default {
  ...
  methods: {
    ...
    validar() {
      ...
      if (this.nombre.length < 1 || this.nombre.length > 50) {
        this.validaMensaje.push(
          "El nombre de la persona debe tener entre 1-30 caracteres."
        );
      }
      if (this.descripcion.length > 255) {
        this.validaMensaje.push(
          "La descripción de la persona no debe tener más de 255 caracteres."
        );
      }
    ...
    eliminar() {
      ...
      axios.delete(`persona/${me._id}`, this.headers).then((datos) => {
        console.log(datos);
      });
    },
  },
